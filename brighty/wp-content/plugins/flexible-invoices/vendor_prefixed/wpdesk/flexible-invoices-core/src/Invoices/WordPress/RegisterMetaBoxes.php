...
class RegisterMetaBoxes implements \WPDeskFIVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
     ...
     * @param WP_Post $post
     */
    public function options_box_callback(\WP_Post $post)
    {
        if ($post->post_type === \WPDeskFIVendor\WPDesk\Library\FlexibleInvoicesCore\WordPress\RegisterPostType::POST_TYPE_NAME) {
