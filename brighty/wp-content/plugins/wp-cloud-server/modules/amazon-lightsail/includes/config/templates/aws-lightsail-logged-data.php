...
function wpcs_aws_lightsail_logged_data_template (  $tabs_content, $page_content, $page_id  ) {
	
	if ( 'aws-lightsail-logged-data' !== $tabs_content ) {
		return;
	}
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_aws_lightsail_logged_data_template', 10, 3 );