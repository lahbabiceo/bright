...
function wpcs_linode_load_balancer_details_template ( $tabs_content, $page_content, $page_id ) {
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_linode_load_balancer_details_template', 10, 3 );
