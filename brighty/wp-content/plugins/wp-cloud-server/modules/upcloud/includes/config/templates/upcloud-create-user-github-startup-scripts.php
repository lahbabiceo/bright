...
function wpcs_upcloud_create_user_github_startup_scrpts_template ( $tab_content, $page_content, $page_id ) {
	
	if ( 'upcloud-create-user-github-startup-scripts' !== $tab_content ) {
		return;
	}
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_upcloud_create_user_github_startup_scrpts_template', 10, 3 );