...
function wpcs_runcloud_logged_data_template ( $tabs_content, $page_content, $page_id ) {
	
	if ( 'runcloud-logged-data' !== $tabs_content ) {
		return;
	}
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_runcloud_logged_data_template', 10, 3 );