...
function wpcs_ploi_logged_data_template ( $tabs_content ) {
	
	if ( 'ploi-logged-data' !== $tabs_content ) {
		return;
	}
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_ploi_logged_data_template' );