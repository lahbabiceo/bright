...
const isUserDefined = metaBox => {
  const builtIn = [// MB Favorite Posts.
  'mbfp-preview-section', 'mbfp_posts', // MB Views.
  'mbv-template-editor', 'mbv-settings', 'mbv-shortcode', // MB Views.
...
function getMapText(modal, currentField) {
  ...
  if ('map_default' === output) {
    return `{{ mb.render_map( ${currentField.id} ) }}`;
  }
