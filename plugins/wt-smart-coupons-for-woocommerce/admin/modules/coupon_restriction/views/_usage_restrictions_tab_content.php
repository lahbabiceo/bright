...
<fieldset class="form-field wt_sc_coupon_products_fieldset wt_sc_coupon_fieldset">
    ...
    <p class="wt_sc_help_text"><?php _e('Products that the coupon will be applied to or that need to be in the cart in order for the discount to be applied by satisfying the min and max quantity restrictions.', 'wt-smart-coupons-for-woocommerce'); ?></p>
</fieldset>

<!-- Exclude product help text -->
<span class="wt_sc_coupon_restriction_help wt_sc_exclude_product_help"><?php _e('Products that the coupon will not be applied to or that cannot be in the cart in order for the discount to be applied. This will not be applicable for percentage and fixed product discount.', 'wt-smart-coupons-for-woocommerce'); ?></span>
...
<fieldset class="form-field wt_sc_coupon_categories_fieldset wt_sc_coupon_fieldset">
    ...
    <p class="wt_sc_help_text"><?php _e('Product categories that the coupon will be applied to or that need to be in the cart in order for the discount to be applied by satisfying the min and max quantity restrictions.', 'wt-smart-coupons-for-woocommerce'); ?></p>
</fieldset>

<!-- Exclude category help text -->
<span class="wt_sc_coupon_restriction_help wt_sc_exclude_category_help"><?php _e('Product categories that the coupon will not be applied to or that cannot be in the cart in order for the discount to be applied. This will not be applicable for percentage and fixed product discount.', 'wt-smart-coupons-for-woocommerce'); ?></span>
