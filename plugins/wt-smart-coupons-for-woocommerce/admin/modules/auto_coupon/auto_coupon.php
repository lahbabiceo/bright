    ...
    public function add_auto_coupon_options($coupon_id, $coupon)
    {
        ...
        woocommerce_wp_checkbox(
            array(
                ...
                'desc_tip' => true,
                'description' => __('Enable to apply the coupon automatically without the need to enter the code manually. (Remember to leave enabled for BOGO).', 'wt-smart-coupons-for-woocommerce'),
