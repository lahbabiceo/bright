...
require_once( BRIGHTY_CORE_PLUGIN_DIR . 'admin/admin-ui-setup.php' );

// Render Admin UI
require_once( BRIGHTY_CORE_PLUGIN_DIR . 'admin/admin-ui-render.php' );

// Do plugin operations
require_once( BRIGHTY_CORE_PLUGIN_DIR . 'functions/do.php' );