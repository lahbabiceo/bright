...
$logged_data = get_option( 'wpcs_digitalocean_logged_data' );

?>

<h2 class="uk-margin-remove-top uk-heading-divider"><?php esc_html_e( 'DigitalOcean Logged Data', 'wp-cloud-server' ); ?></h2>

<p><?php esc_html_e( 'This page provides a log of the main actions performed by the DigitalOcean module.', 'wp-cloud-server' ); ?></p>
