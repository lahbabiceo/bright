...
add_action( 'admin_post_nopriv_handle_edit_digitalocean_template', 'wpcs_handle_edit_digitalocean_template' );
add_action( 'admin_post_handle_edit_digitalocean_template', 'wpcs_handle_edit_digitalocean_template' );

function wpcs_handle_edit_digitalocean_template() {
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_name'] ) ) {
		$server_name = $_POST['wpcs_digitalocean_template_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_type'] ) ) {
		$server_type = $_POST['wpcs_digitalocean_template_type'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_host_name'] ) ) {
		$server_host_name = $_POST['wpcs_digitalocean_template_host_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_region'] ) ) {
		$server_region = $_POST['wpcs_digitalocean_template_region'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_size'] ) ) {
		$server_size = $_POST['wpcs_digitalocean_template_size'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_ssh_key'] ) ) {
		$server_ssh_key = $_POST['wpcs_digitalocean_template_ssh_key'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_startup_script_name'] ) ) {
		$server_startup_script = $_POST['wpcs_digitalocean_template_startup_script_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_enable_backups'] ) ) {
		$server_backups = $_POST['wpcs_digitalocean_template_enable_backups'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_digitalocean_template_site_counter'] ) ) {
		$server_site_counter = $_POST['wpcs_digitalocean_template_site_counter'];
	}
	...
	$feedback[] = array(
        'setting' => 'wpcs_digitalocean_confirm_template_delete',
        'code'    => 'settings_updated',
        'message' => 'The DigitalOcean Template was Successfully Updated',
        'type'    => 'success',
		'status'  => 'new',
    );
