...
add_action( 'admin_post_nopriv_handle_edit_aws_lightsail_template', 'wpcs_handle_edit_aws_lightsail_template' );
add_action( 'admin_post_handle_edit_aws_lightsail_template', 'wpcs_handle_edit_aws_lightsail_template' );

function wpcs_handle_edit_aws_lightsail_template() {
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_name'] ) ) {
		$server_name = $_POST['wpcs_aws_lightsail_template_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_type'] ) ) {
		$server_type = $_POST['wpcs_aws_lightsail_template_type'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_host_name'] ) ) {
		$server_host_name = $_POST['wpcs_aws_lightsail_template_host_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_region'] ) ) {
		$server_region = $_POST['wpcs_aws_lightsail_template_region'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_size'] ) ) {
		$server_size = $_POST['wpcs_aws_lightsail_template_size'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_ssh_key'] ) ) {
		$server_ssh_key = $_POST['wpcs_aws_lightsail_template_ssh_key'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_startup_script_name'] ) ) {
		$server_startup_script = $_POST['wpcs_aws_lightsail_template_startup_script_name'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_enable_backups'] ) ) {
		$server_backups = $_POST['wpcs_aws_lightsail_template_enable_backups'];
	}
	
	// Save the ServerPilot Template Name
	if ( isset( $_POST['wpcs_aws_lightsail_template_site_counter'] ) ) {
		$server_site_counter = $_POST['wpcs_aws_lightsail_template_site_counter'];
	}
	...
	$feedback[] = array(
        'setting' => 'wpcs_aws_lightsail_template_name',
        'code'    => 'settings_updated',
        'message' => 'The AWS Lightsail Template was Successfully Updated',
        'type'    => 'success',
		'status'  => 'new',
    );
