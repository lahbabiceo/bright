...
function wpcs_upcloud_logged_data_template ( $tabs_content, $page_content, $page_id ) {
	
	if ( 'upcloud-logged-data' !== $tabs_content ) {
		return;
	}
...
add_action( 'wpcs_control_panel_tab_content', 'wpcs_upcloud_logged_data_template', 10, 3 );